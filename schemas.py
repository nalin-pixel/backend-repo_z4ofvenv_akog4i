...
class Event(BaseModel):
    ...
    date: datetime = Field(..., description="Event date and time in ISO format")
...
class MemberApplication(BaseModel):
    """
    Join requests from prospective members
    Collection name: "memberapplication"
    """
    name: str = Field(..., description="Full name")
    email: EmailStr = Field(..., description="Email address")
    interests: Optional[str] = Field(None, description="Short note about interests")
